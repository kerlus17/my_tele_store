...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Started value)?  started,TResult Function( RemoveCategoryEvent value)?  removeCategory,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case RemoveCategoryEvent() when removeCategory != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Started value)  started,required TResult Function( RemoveCategoryEvent value)  removeCategory,}){
final _that = this;
switch (_that) {
case _Started():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Started value)?  started,TResult? Function( RemoveCategoryEvent value)?  removeCategory,}){
final _that = this;
switch (_that) {
case _Started() when started != null:
return started(_that);case RemoveCategoryEvent() when removeCategory != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function( String CategoryId)?  removeCategory,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case RemoveCategoryEvent() when removeCategory != null:
return removeCategory(_that.CategoryId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function( String CategoryId)  removeCategory,}) {final _that = this;
switch (_that) {
case _Started():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function( String CategoryId)?  removeCategory,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case RemoveCategoryEvent() when removeCategory != null:
return removeCategory(_that.CategoryId);case _:
...
class RemoveCategoryEvent implements DeleteCategoryEvent {
...
@override
String toString() {
  return 'DeleteCategoryEvent.removeCategory(CategoryId: $CategoryId)';
}
...
class LoadinState implements DeleteCategoryState {
  const LoadinState({required this.categoryId});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LoadinStateCopyWith<LoadinState> get copyWith => _$LoadinStateCopyWithImpl<LoadinState>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoadinState&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId));
}
...
/// @nodoc
abstract mixin class $LoadinStateCopyWith<$Res> implements $DeleteCategoryStateCopyWith<$Res> {
  factory $LoadinStateCopyWith(LoadinState value, $Res Function(LoadinState) _then) = _$LoadinStateCopyWithImpl;
@useResult
$Res call({
 String categoryId
});
...
/// @nodoc
class _$LoadinStateCopyWithImpl<$Res>
    implements $LoadinStateCopyWith<$Res> {
  _$LoadinStateCopyWithImpl(this._self, this._then);

  final LoadinState _self;
  final $Res Function(LoadinState) _then;

/// Create a copy of DeleteCategoryState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? categoryId = null,}) {
  return _then(LoadinState(
categoryId: null == categoryId ? _self.categoryId : categoryId // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class SuccessState implements DeleteCategoryState {
  const SuccessState();
...
class ErrorState implements DeleteCategoryState {
